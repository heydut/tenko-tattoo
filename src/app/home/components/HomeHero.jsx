...
export default function HomeHero() {
  return (
    <div className="relative -mt-16 flex items-center justify-center">
      ...
      <main className="relative z-10 margin-x margin-y flex flex-col items-center text-center gap-20 mt-6 max-sm:mt-16">
        ...
        <h5 className="relative z-20 w-[70%] max-lg:w-[80%] max-sm:w-full text-lg tracking-normal ">
